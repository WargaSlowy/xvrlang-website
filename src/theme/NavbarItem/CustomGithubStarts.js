...
export default function CustomGithubStarsNavbarItem(props) {
  ...
  const linkLabel =
    stars !== null
      ? `Xvr on GitHub (${fullCount} stars)`
      : hasError
        ? "Xvr on GitHub (star count unavailable)"
        : "Xvr on GitHub (loading star count)";
  ...
  return (
    ...
    >
      <span className="github-stars-navbar-item__icon" aria-hidden="true">
        ⭐
      </span>
